...
public class DictionaryLLTester {
	...
	{
		assertEquals("Testing an empty dict", 0, dictLL.size());
	...
	public void testIsWord()
	{
		...
		assertEquals("Testing isword on my dict", false, dictLL.isWord("tEst"));
	...
	public void addWord()
	{
		...
		assertEquals("Testing tEst is not in dict", false, dictLL.isWord("tEst"));
		...
		assertEquals("Testing tEst is in dict", true, dictLL.isWord("tEst"));
		assertEquals("Testing fuck teSt is in dict", true, dictLL.isWord("teSt"));
		assertEquals("getting size on my added dict", 1, dictLL.size());
