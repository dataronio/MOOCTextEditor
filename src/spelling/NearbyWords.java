...
public class NearbyWords implements SpellingSuggest {
   ...
   public static void main(String[] args) {
	   ...
	   List<String> l1 = w.distanceOne(word1, true);
	   ...
	   // do the same for word1
	   List<String> suggest1 = w.suggestions(word1, 10);
	   System.out.println("Spelling Suggestions for \""+word1+"\" are:");
